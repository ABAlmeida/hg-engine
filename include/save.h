...
BOOL LONG_CALL SaveVarsFlags_CheckAlphPuzzleFlag(void *eventData, int puzzleIndex);
BOOL LONG_CALL SaveVarsFlags_CheckBugContestFlag(void *eventData);
BOOL LONG_CALL SaveVarsFlags_CheckSafariSysFlag(void *eventData);
