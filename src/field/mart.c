...
#define BADGE_MART_REPEL_ITEMS     { ITEM_POKE_BAIT, 0 }
#define MART_REPEL_ITEMS(...)      ITEM_POKE_BAIT
#define MART_BAIT_ITEM             ITEM_POKE_BAIT,
#define POKEATHLON_RARE_CANDY_ITEM
#else
#define BADGE_MART_REPEL_ITEMS \
    { ITEM_REPEL, 1 },         \
    { ITEM_SUPER_REPEL, 3 },   \
    { ITEM_MAX_REPEL, 5 }
#define MART_REPEL_ITEMS(...)      __VA_ARGS__
#define MART_BAIT_ITEM
#define POKEATHLON_RARE_CANDY_ITEM { ITEM_RARE_CANDY, 2000 },
#endif
...
u16 sGoldenrodDepartmentLower2F[] = {
    ...
    MART_REPEL_ITEMS(ITEM_REPEL, ITEM_SUPER_REPEL, ITEM_MAX_REPEL),
    ITEM_GRASS_MAIL, ITEM_FLAME_MAIL, ITEM_BUBBLE_MAIL, ITEM_SPACE_MAIL, 0xFFFF
};
...
u16 sIndigoPlateau[] = {
    ITEM_ULTRA_BALL,
    MART_REPEL_ITEMS(ITEM_MAX_REPEL),
    ITEM_HYPER_POTION, ITEM_MAX_POTION, ITEM_FULL_RESTORE, ITEM_REVIVE, ITEM_FULL_HEAL, 0xFFFF
};
...
u16 sMtMoonSquare[] = {
    ITEM_POKE_DOLL, ITEM_FRESH_WATER, ITEM_SODA_POP, ITEM_LEMONADE,
    MART_REPEL_ITEMS(ITEM_REPEL),
    ITEM_HEART_MAIL, 0xFFFF
};

u16 sMahoganyPreRocketHideout[] = {
    ITEM_TINY_MUSHROOM, ITEM_POKE_BALL,
    MART_BAIT_ITEM
    ITEM_POTION, 0xFFFF
};
...
u16 sMahoganyPostRocketHideout[] = {
    ...
    MART_REPEL_ITEMS(ITEM_SUPER_REPEL),
    ITEM_REVIVE, ITEM_AIR_MAIL, 0xFFFF
};
...
#undef BADGE_MART_REPEL_ITEMS
#undef MART_REPEL_ITEMS
#undef MART_BAIT_ITEM
#undef POKEATHLON_RARE_CANDY_ITEM
