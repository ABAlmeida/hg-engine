...
species, level, method, or slot assignment changes.

See `guides/CHANGING_WILD_ENCOUNTERS.md` for the source format and editing
workflow.

## Land encounter slot weights
...
- Remove all Rock Smash encounters.
...
- Preserve the existing Unown encounters.
