...
enum ItemFieldUseFuncId {
    ITEM_FIELD_USE_FUNC_REVEAL_GLASS = 30,
    ITEM_FIELD_USE_FUNC_DNA_SPLICERS,
    ITEM_FIELD_USE_FUNC_ABILITY_CAPSULE,
    ITEM_FIELD_USE_FUNC_MINT,
    ITEM_FIELD_USE_FUNC_NECTAR,
    ITEM_FIELD_USE_FUNC_ROTOM_CATALOG,
    ITEM_FIELD_USE_FUNC_BAIT,
    ITEM_FIELD_USE_FUNC_REUSABLE_HEALER,
    ITEM_FIELD_USE_FUNC_LAPTOP,
    ITEM_FIELD_USE_FUNC_COUNT,
};
