...
LEVEL_CAP_REWARDS_TARGET := $(BUILD)/a028/9_19
LEVEL_CAP_REWARDS_DEPENDENCIES := data/TrainerLevelCaps.c include/level_cap.h
LEVEL_CAP_REWARDS_OBJS := build/TrainerLevelCaps.o
LEVEL_CAP_REWARDS_BIN := build/TrainerLevelCaps.bin

$(LEVEL_CAP_REWARDS_BIN): $(LEVEL_CAP_REWARDS_DEPENDENCIES)
	$(CC) $(CFLAGS) -c data/TrainerLevelCaps.c -o $(LEVEL_CAP_REWARDS_OBJS)
	$(OBJCOPY) -O binary $(LEVEL_CAP_REWARDS_OBJS) $@

NARC_FILES += $(LEVEL_CAP_REWARDS_BIN)
